...
var getZergDetail = function (from, from_id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                from_data = null;
                if (!(from === ROOM_FROM_1.ROOM_FROM.ONLINE)) return [3 /*break*/, 2];
                return [4 /*yield*/, modelOnlie.get(~~from_id)];
            case 1:
                list = _a.sent();
                from_data = {
                    list: list,
...
var getZergPlayUrl = function (from, tagerUrl) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                playUrl = null;
                if (from === ROOM_FROM_1.ROOM_FROM.ONLINE) {
            ...
            case 3:
                playUrl = _a.sent();
                _a.label = 4;
            case 4: return [2 /*return*/, playUrl];
        }
    });
}); };
exports.getZergPlayUrl = getZergPlayUrl;
