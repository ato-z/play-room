 ...
 */
var ModelUser = /** @class */ (function (_super) {
     ...
     * ```
     */
    ModelUser.prototype.get = function (uid) {
        return __awaiter(this, void 0, void 0, function () {
            var detail;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.find(uid)];
                    case 1:
                        detail = _a.sent();
                        if (detail === null) {
                            throw new exceptions_1.ExceptionUser.MissUser();
                        }
